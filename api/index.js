...
app.get("/edit/certificate", (_req, res) => {
  res.sendFile(path.join(__dirname, "../views/UpdateCertificate.html"));
});

app.get("/certificates", (_req, res) => {
  res.sendFile(path.join(__dirname, "../views/ListCertificates.html"));
});
